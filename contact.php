<!-- Title page -->
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/hobi.jpg')">
            ...
            <div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
                ...
                <div class="flex-w w-full p-b-42">
                    ...
                    <div class="size-212 p-t-2">
                        ...
                        <p class="stext-115 cl1 size-213 p-t-18">(+855)123456789</p>
                    </div>
                </div>
                ...
                <div class="flex-w w-full">
                    ...
                    <div class="size-212 p-t-2">
                        ...
                        <p class="stext-115 cl1 size-213 p-t-18">az@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
